...
if docker ps | grep -q neo4j; then
    ...
    docker-compose -f dockerfiles/docker-compose.simple.yml down neo4j || true
    docker-compose -f dockerfiles/docker-compose.simple.yml up -d neo4j
...
docker-compose -f dockerfiles/docker-compose.simple.yml up -d redis neo4j qdrant
...
docker-compose -f dockerfiles/docker-compose.simple.yml ps
